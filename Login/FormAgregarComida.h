...
namespace Login {
	...
	/// <summary>
	/// Resumen de FormAgregarComida
	/// </summary>
	public ref class FormAgregarComida : public System::Windows::Forms::Form
	{
	public:
		FormAgregarComida(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(FormAgregarComida::typeid));
			...
			this->txtNombreComida->TabIndex = 10;
			// 
			// btnGuardarRol
			// 
			...
			this->btnGuardarRol->TabIndex = 11;
			this->btnGuardarRol->Text = L"Guardar";
			this->btnGuardarRol->UseVisualStyleBackColor = false;
			this->btnGuardarRol->Click += gcnew System::EventHandler(this, &FormAgregarComida::btnGuardarRol_Click);
			// 
			// FormAgregarComida
			// 
			...
			this->Name = L"FormAgregarComida";
			this->Text = L"FormAgregarComida";
...
#pragma endregion
	private: System::Void btnGuardarRol_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->data->InsertarComida(this->txtNombreComida->Text);
