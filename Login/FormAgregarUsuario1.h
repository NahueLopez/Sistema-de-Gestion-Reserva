...
namespace Login {
	...
	/// </summary>
	public ref class FormAgregarUsuario1 : public System::Windows::Forms::Form
	{
	public:
		FormAgregarUsuario1(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txtAreaUsuario = (gcnew System::Windows::Forms::TextBox());
			this->SuspendLayout();
			// 
			// btnGuardarUsuario
			// 
			this->btnGuardarUsuario->BackColor = System::Drawing::Color::LightGoldenrodYellow;
			this->btnGuardarUsuario->Cursor = System::Windows::Forms::Cursors::Hand;
			this->btnGuardarUsuario->Location = System::Drawing::Point(480, 188);
			...
			this->btnGuardarUsuario->Click += gcnew System::EventHandler(this, &FormAgregarUsuario1::btnGuardarUsuario_Click);
			// 
			// label1
			// 
			...
			// txtAreaUsuario
			// 
			this->txtAreaUsuario->Location = System::Drawing::Point(190, 355);
			this->txtAreaUsuario->Multiline = true;
			this->txtAreaUsuario->Name = L"txtAreaUsuario";
			this->txtAreaUsuario->Size = System::Drawing::Size(248, 35);
			this->txtAreaUsuario->TabIndex = 14;
			// 
			// FormAgregarUsuario
			// 
			...
			this->Controls->Add(this->txtAreaUsuario);
			...
			this->Name = L"FormAgregarUsuario1";
			this->Text = L"FormAgregarUsuario1";
...
#pragma endregion
	...
	private: System::Void btnGuardarUsuario_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->data->InsertarUsuario(this->txtNombreUsuario->Text, this->txtApellidoUsuario->Text, this->txtDniUsuario->Text, this->txtNacimientoUsuario->Text, this->txtDireccionUsuario->Text, this->txtMatriculaUsuario->Text, this->txtAreaUsuario->Text);
